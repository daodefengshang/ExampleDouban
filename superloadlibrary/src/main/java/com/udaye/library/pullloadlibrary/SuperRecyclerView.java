            ...
            listener = new OnScrollListener() {
                ...
                public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                    ...
                    if (newState == RecyclerView.SCROLL_STATE_IDLE && onLoadMoreListener != null) {
                        ...
                        //如果相等则说明已经滑动到最后了
                        RecyclerViewCommonAdapter commonAdapter = (RecyclerViewCommonAdapter) recyclerView.getAdapter();
                        if (commonAdapter != null && lastPosition == commonAdapter.getBottomPos()) {
